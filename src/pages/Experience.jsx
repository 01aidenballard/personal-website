    ...
    <div className="bg-slate-50">
      <div className="container mx-auto px-4 py-3">
        <div className="grid grid-cols-2 gap-12">
          ...
          <div className="p-2 bg-white rounded-lg shadow-xl border border-slate-200 hover:scale-102 h-[90%]" onClick={handleCardClick} hidden={isClicked}>
          ...
          <div className="p-6 bg-white rounded-lg shadow-xl border border-slate-200 hover:scale-102 h-[90%]" onClick={handleCardClick} hidden={!isClicked}>
